...
typedef struct camera_module {
    ...
    /**
    * Select the CVBS Camera input port (Add ATC)
    *
    * @param value: the number of CVBS input port
    *
    * @return {@code true} if the port is set up successfully
    *       {@code false} if the port is set up failed or other abnormal situation.
    */
    bool (*set_camera_cvbs_port)(int port_id);
