...
/**
 * Callback for sending cpbs list to app
 */
typedef void (* bthf_client_cpbs_list_callback) (int pathlist);

/**
 * Callback for sending cpbs value to app
 */
typedef void (* bthf_client_cpbs_value_callback) (int type, int used, int total);

/**
 * Callback for sending cpbr list to app
 */
typedef void (* bthf_client_cpbr_list_callback) (int start, int end);

/**
 * Callback for sending cpbr item to app
 */
typedef void (* bthf_client_cpbr_item_callback) (int index, const char *number, const char *name);

/**
 * Callback for sending cscs list to app
 */
typedef void (* bthf_client_cscs_list_callback) (int charsetlist);

/**
 * Callback for sending cpbs list to app
 */
typedef void (* bthf_client_cscs_value_callback) (int value);

/**
 * Callback for requested factory from AG
 */
typedef void (* bthf_client_ag_factory_callback) (const char *factory);

/**
 * Callback for requested serial from AG
 */
typedef void (* bthf_client_ag_serial_callback) (const char *serial);
...
typedef struct {
    ...
    bthf_client_cpbs_list_callback         cpbs_list_cb;
    bthf_client_cpbs_value_callback        cpbs_value_cb;
    bthf_client_cpbr_list_callback         cpbr_list_cb;
    bthf_client_cpbr_item_callback         cpbr_item_cb;
    bthf_client_cscs_list_callback         cscs_list_cb;
    bthf_client_cscs_value_callback        cscs_value_cb;
    bthf_client_ag_factory_callback        ag_factory_cb;
    bthf_client_ag_serial_callback         ag_serial_cb;
...
typedef struct {
    ...
    /** query phone memory storage list*/
    bt_status_t (*query_cpbs_list) (void);

    /** query current phone memory storage*/
    bt_status_t (*query_cpbs_value) (void);

    /** set phone memory storage*/
    bt_status_t (*set_cpbs_value) (int path);

    /** read phonebook entries list size*/
    bt_status_t (*query_cpbr_list) (void);

    /** read phonebook*/
    bt_status_t (*request_cpbr_item) (int start, int end);

    /** query phone charset list*/
    bt_status_t (*query_cscs_list) (void);

    /** query current phone charset*/
    bt_status_t (*query_cscs_value) (void);

    /** set phone charset*/
    bt_status_t (*set_cscs_value) (int charset);

    /** query ag factory*/
    bt_status_t (*query_ag_factory) (void);

    /** query ag serial*/
    bt_status_t (*query_ag_serial) (void);
