...
/* Bluetooth AV output states */
typedef enum {
	BTAV_AUDIO_OUTPUT_NONE = 0,
	BTAV_AUDIO_OUTPUT_DISABLE,
	BTAV_AUDIO_OUTPUT_ENABLE,
	BTAV_AUDIO_OUTPUT_VOLUME,
	BTAV_AUDIO_OUTPUT_SET_STATE,
} btav_audio_output_t;
...
typedef struct {
	...
	void (*set_audio)(int mode, int arg);
