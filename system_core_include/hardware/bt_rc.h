...
typedef enum {
    BTRC_PDU_GET_CAPABILITIES =          0x10,
    BTRC_PDU_LIST_PLAYER_APP_ATTR =      0x11,
    BTRC_PDU_LIST_PLAYER_APP_VALUES  =   0x12,
    BTRC_PDU_GET_CUR_PLAYER_APP_VALUE =  0x13,
    BTRC_PDU_SET_PLAYER_APP_VALUE =      0x14,
    BTRC_PDU_GET_PLAYER_APP_ATTR_TEXT =  0x15,
    BTRC_PDU_GET_PLAYER_APP_VALUE_TEXT = 0x16,
    BTRC_PDU_INFORM_DISPLAY_CHARSET =    0x17,
    BTRC_PDU_INFORM_BATTERY_STAT_OF_CT = 0x18,
    BTRC_PDU_GET_ELEMENT_ATTR =          0x20,
    BTRC_PDU_GET_PLAY_STATUS =           0x30,
    BTRC_PDU_REGISTER_NOTIFICATION =     0x31,   
    BTRC_PDU_REQUEST_CONTINUATION_RSP =  0x40,
    BTRC_PDU_ABORT_CONTINUATION_RSP =    0x41,    
}btrc_vendor_pdu_id_t;
...
typedef void (* btrc_get_capabilities_rsp_callback) (int id, int count,  uint8_t *p_data);

typedef void (* btrc_get_elementattrs_rsp_callback) (uint8_t num_attr, btrc_element_attr_val_t *p_attrs);

typedef void (* btrc_get_playstatus_rsp_callback)(uint8_t play_status, uint32_t song_len, uint32_t song_pos);

typedef void (* btrc_reg_notification_rsp_callback) (uint8_t event_id, uint8_t type, 
                                                          btrc_register_notification_t *p_param);
...
typedef struct {
    ...
    btrc_get_capabilities_rsp_callback          getCapabilities_rsp_cb;
    btrc_get_elementattrs_rsp_callback          getElementattrs_rsp_cb;
    btrc_get_playstatus_rsp_callback            getPlaystatus_rsp_cb;
    btrc_reg_notification_rsp_callback          regNotification_rsp_cb;
...
typedef struct {
    ...
    /** Metadata transfer interfaces */    
    bt_status_t (*get_capabilities_cmd)(uint8_t cap_id);
    bt_status_t (*get_elementattrs_cmd)(uint64_t id, uint8_t count, uint32_t* attrs);
    bt_status_t (*get_playstatus_cmd)(void);
    bt_status_t (*reg_notification_cmd)(uint8_t event_id, uint32_t playback_interval);
