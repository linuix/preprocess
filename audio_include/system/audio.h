...
typedef enum {
    ...
    AUDIO_STREAM_TTS              = 9,  /* Transmitted Through Speaker.
                                         ...
                                         */
    AUDIO_STREAM_GIS              = 10,  /*gis stream*/
    AUDIO_STREAM_BACKCAR          = 11,  /*backcar stream*/
    AUDIO_STREAM_RDS              = 12,  /*rds stream*/
    AUDIO_STREAM_ADAS             = 13,  /*adas stream*/
    AUDIO_STREAM_SMIX             = 14,  /*smix stream*/
    AUDIO_STREAM_BOOT             = 15, /*For MTK boot animation*/
    AUDIO_STREAM_VIBSPK           = 16, /*For MTK vibration speaker*/
    AUDIO_STREAM_ACCESSIBILITY    = 17, /* For accessibility talk back prompts */
    AUDIO_STREAM_REROUTING        = 18, /* For dynamic policy output mixes */
    AUDIO_STREAM_PATCH            = 19, /* For internal audio flinger tracks. Fixed volume */
...
typedef enum {
    ...
    AUDIO_CONTENT_TYPE_GIS          = 5,
    AUDIO_CONTENT_TYPE_BACKCAR      = 6,
    AUDIO_CONTENT_TYPE_RDS          = 7,
    AUDIO_CONTENT_TYPE_ADAS         = 8,
    AUDIO_CONTENT_TYPE_SMIX         = 9,
    AUDIO_CONTENT_TYPE_BOOT         = 10,
    AUDIO_CONTENT_TYPE_VIBSPK       = 11,
...
typedef enum {
    ...
    AUDIO_USAGE_GIS                                = 16,
    AUDIO_USAGE_BACKCAR                            = 17,
    AUDIO_USAGE_RDS                                = 18,
    AUDIO_USAGE_ADAS                               = 19,
    AUDIO_USAGE_SMIX                               = 20,
    AUDIO_USAGE_BOOT                               = 21,
    AUDIO_USAGE_VIBSPK                             = 22,
...
enum {
    ...
    AUDIO_DEVICE_OUT_ADSP                      = 0x1000000,
...
//<MTK_AUDIO_ADD
    ...
    AUDIO_OUTPUT_FLAG_NAVIGATOR        = 0x1000,
    AUDIO_OUTPUT_FLAG_TO_ADSP          = 0x2000
//MTK_AUDIO_ADD>
